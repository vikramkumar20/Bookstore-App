...
function Navbar() {
    ...
    // theme variable has been used to manage the dark and light theme.
    ...
    // The Sticky variable has been used to give position to the Navbar.
            ...
            >
                <div className="navbar ">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div>
                            <a className="bg-pink-500 text-white p-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
...
// ctrl+shift+l to select all similar text